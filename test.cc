...
const char *dbfile_dir = "dbfile_dir/"; // dir where binary heap files should be stored
// const char *tpch_dir = "/cise/homes/roy.rahul/dbi/tpch-dbgen/";		 // dir where dbgen tpch files (extension *.tbl) can be found
